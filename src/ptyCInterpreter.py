    ...
    def declaracao(self,declaracao):
        ...
        for d in declaracao.children:
            if(type(d) == Tree):
                ...
                self.info["variaveis"][self.variavel_atual]["tipo_da_variavel"] = tipo_atual
                self.info["variaveis"][self.variavel_atual]["foi_declarada"] = True
                if self.is_list:
                    self.is_list = False
        ...
        for a in atribuicao.children:
            if(type(a) == Tree):
                if a.data == "var":
                    ...
                    self.variavel_atual = a.children[0]
                    ...
                    if self.is_list:
                        self.info["variaveis"][self.variavel_atual]["foi_inicializada"] = True
                    self.is_list = False
                elif a.data == "objeto":
                    atrib.append({a.data: self.visit(a)})
            else:
    ...
    def var(self,var):
        ...
        for v in var.children:
            ...
            if(type(v) == Tree):
                ...
                variable_name = str(self.variavel_atual) +  "[" + str(self.list_value) + "]"
                ...
                self.list_value = ""
                self.variavel_atual = variable_name
                ...
                if (type(v) == Token):
                    if self.is_list == False:
                        ...
                        if first == False:
                            ...
                            self.variavel_atual = str(v.value)
    ...
    def objeto(self,objeto):
        ...
        for o in objeto.children:
            if(type(o) == Tree):
                ...
                if o.data == "expressao":
                    self.info["variaveis"][self.variavel_atual]["valores"].append(self.expression)
                    self.is_expression = False
                    self.expression = ""
            else:
                if (type(o) == Token):
                    self.info["variaveis"][self.variavel_atual]["valores"].append(o.value)
                    obj.append({o.type: o})
                        ...
                        self.list_value += str(atomo.value)
                         ...
                         if self.is_variable:
                            if(not self.is_expression):
                               self.info["variaveis"][self.variavel_atual]["valores"].append(atomo.value)
                            else:
